                ...
                <Cards style={styles.containerCard}>
                    <DataTable >
                        ...
                        <DataTable.Row style={styles.Row1}>
                            ...
                            <DataTable.Cell numeric> <Text style={styles.Text2}>10,000 to 15,0000</Text></DataTable.Cell>
                            {/* <DataTable.Cell numeric>6.0</DataTable.Cell> */}
                        </DataTable.Row>

                        <DataTable.Row style={styles.Row2}>
                            <DataTable.Cell><Text style={styles.Text2}>Flate Tire</Text></DataTable.Cell>
                            <DataTable.Cell numeric><Text style={styles.Text2}>10,000 to 20,000</Text></DataTable.Cell>
                            {/* <DataTable.Cell numeric>8.0</DataTable.Cell> */}
                        </DataTable.Row>
                        <DataTable.Row style={styles.Row1}>
                            <DataTable.Cell><Text style={styles.Text2}>Motorcylce Accident</Text></DataTable.Cell>
                            <DataTable.Cell numeric><Text style={styles.Text2}>10,000 to 40,0000</Text></DataTable.Cell>
                            {/* <DataTable.Cell numeric>8.0</DataTable.Cell> */}
                        </DataTable.Row>
                        <DataTable.Row style={styles.Row2}>
                            <DataTable.Cell><Text style={styles.Text2}>Vendalism</Text></DataTable.Cell>
                            <DataTable.Cell numeric> <Text style={styles.Text2}>5,000 to 30,000</Text></DataTable.Cell>
                            {/* <DataTable.Cell numeric>8.0</DataTable.Cell> */}
                        </DataTable.Row>
